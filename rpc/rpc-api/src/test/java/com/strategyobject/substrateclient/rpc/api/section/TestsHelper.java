...
public class TestsHelper {
    static final MetadataProvider METADATA_PROVIDER = mock(MetadataProvider.class);
    ...
    static final RpcEncoderRegistry RPC_ENCODER_REGISTRY = new RpcEncoderRegistry();
    ...
    static final RpcDecoderRegistry RPC_DECODER_REGISTRY = new RpcDecoderRegistry();
